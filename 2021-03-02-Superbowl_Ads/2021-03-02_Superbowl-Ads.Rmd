...
ggplot()+
  ...
  labs(subtitle = "Most Viewed Supbowl Ads by these Brands Over Time",
       caption = "Data: FiveThirtyEight | @kkakey") +
  theme(text = element_text(family="SoccerLeague-Regular"),
        ...
        plot.subtitle = element_text(hjust=.5, vjust=20),
        plot.caption =  element_text(color="white", hjust=1.1, size=6,
                                     margin = margin(t = 23, b = -23)),
        axis.text.y = element_text(color="white"),
        axis.title  = element_text(color="white"),
        ) +
    geom_text(aes(x=2012, y=26, label="Of the top 30 most viewed superbowl commericals in the dataset, one-thrid are Doritos and one-fifth are Bud Light.\nThis plot shows the logged view count of each company's top commericals from 2004 to 2020.",
  ...
  ggsave("plot.png", width=12, dpi=800)
```
